package com.m_alrajab.android.marketeye.ui.widget;
...
import com.m_alrajab.android.marketeye.model.db.QuoteDatabase;
    ...
    public RemoteViewsFactory onGetViewFactory(Intent intent) {
        ...
        return new RemoteViewsFactory() {
            ...
            public RemoteViews getViewAt(int position) {
                ...
                intent.putExtra(com.m_alrajab.android.marketeye.utils.Constants.GRAPH_ARG_KEY,ticker);
